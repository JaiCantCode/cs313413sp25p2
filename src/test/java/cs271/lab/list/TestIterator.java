...
public class TestIterator {
  ...
  public void setUp() throws Exception {
    ...
    // TODO Question: Also try with a LinkedList - does it make any difference? ANSWER: When testing both, there seemed to not be much of a difference.
  }
  ...
  public void testRemove() {
    ...
    while (i.hasNext()) {
      if (i.next() == 77) {
        i.remove(); // TODO Question: What happens if you use list.remove(Integer.valueOf(77))? ANSWER: It will throw an Exception because you arent allowed to manipulate an object that is currently being iterated over
