...
public class TestList {
  ...
  public void testRemoveObject() {
    ...
    list.add(77);
    list.add(6);
    list.remove(5); // TODO Question: What does this method do? ANSWER: It removes the value at index 5 in 'list'
    // TODO fix the expected values in the assertions below
    ...
    assertEquals(77, list.get(3).intValue());
    list.remove(Integer.valueOf(5)); // TODO Question: What does this one do? ANSWER: It removes the value at index 5 in 'list'
